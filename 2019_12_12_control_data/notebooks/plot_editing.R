...
tbl_control = fread("/Users/aaronmck/Desktop/code/base_editing/2019_12_12_control_data/notebooks/palindrome_sequence_controls.txt")
...
ggsave(gg,file=paste(plot_loc,"base_editing_proportion_control.png",sep=""),width=12, height=4)

# cases

tbl_control = fread("/Users/aaronmck/Desktop/code/base_editing/2019_12_12_control_data/notebooks/palindrome_sequence_cases.txt")
...
gg = ggplot(tbl.control.melt) + 
  ...
  xlab("Guides, ordered by matched target percentage") + 
  ylab("Percent of targets that match the guide")
ggsave(gg,file=paste(plot_loc,"base_editing_proportion_cases.png",sep=""),width=12, height=4)

# load up the edited and not per-target
control = "/Users/aaronmck/Desktop/code/base_editing/2019_12_12_control_data/notebooks/palindromes_base_counts_control.txt"
edited = "/Users/aaronmck/Desktop/code/base_editing/2019_12_12_control_data/notebooks/palindromes_base_counts_edited.txt"
...
ggsave(p,file=paste(plot_loc,"control_counts_editing_rate.png",sep=""),width=8,height=3)
...
p<- ggplot(melted.edited.counts.sumary, aes(x=variable, y=value)) + 
  ...
  xlab("Target position") +
  ylab("proportion edited (with error bars)")
ggsave(p,file=paste(plot_loc,"edited_counts_editing_rate.png",sep=""),width=8,height=3)